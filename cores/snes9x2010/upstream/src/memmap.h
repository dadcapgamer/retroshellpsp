...
#ifdef PSP
/* RetroSuite's PSP-1000 target has a 16 MiB core arena. Keep the ROM
 * allocation to the largest size the frontend currently admits so the
 * SA-1 core and renderer still fit alongside a 4 MiB game image. */
